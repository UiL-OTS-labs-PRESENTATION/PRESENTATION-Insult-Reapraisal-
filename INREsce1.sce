...
pcl_file = "INREpcl1.pcl"; 					# pcl file name geven
scenario = "INREsce1.sce"; 						# for log-file
...
trial {													# trial define
	...
	trial_duration = forever;                 # the length of the trial in milliseconds      
	picture { 											# het object is een picture
		text { caption = "Lees de uitspraak aandachtig.
